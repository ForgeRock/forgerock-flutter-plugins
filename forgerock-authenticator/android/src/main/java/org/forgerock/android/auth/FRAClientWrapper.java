...
public class FRAClientWrapper {
    ...
    private final FRATokenUtil oathTokenConverter;
    ...
    private FRAClientWrapper(Context context) {
        ...
        this.oathTokenConverter = new FRATokenUtil();
    }
    ...
    public void getOathTokenCode(String mechanismId, Result flutterResult) {
        ...
        if(oathMechanism != null) {
            try {
                flutterResult.success(oathTokenConverter.toMapObject(oathMechanism.getOathTokenCode()));
